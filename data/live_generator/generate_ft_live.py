...
folder_root = './data/live_generator/'

label = folder_root + 'LIVE2_labels.mat'
shape = ['gblur','wn','jpeg','jp2k','fastfading']
data_path = '../dataset/live/'
list_file = folder_root + 'ref' + '.txt'
...
train_file = open(folder_root+'ft_live_train.txt', "w")
test_file = open(folder_root+'ft_live_test.txt', "w")
